function createUnityInstance(t, n, d) {
  ...
  function r(e) {
    var t = e.reason || e.error,
      ...
      r = e.filename || (t && (t.fileName || t.sourceURL)) || "",
      e = e.lineno || (t && (t.lineNumber || t.line)) || 0,
      t = t && t.stack ? t.stack.toString() : r && e ? "at " + r + ":" + e : "";
    "" === n && (n = "An unspecified error occured."),
      S((n += "\n" + (t = t.startsWith(n) ? t.substring(n.length) : t).trim()), r, e);
  }
  function e(e, t, n) {
    var r = e[t];
    (void 0 !== r && r) ||
  ...
  function u(e) {
    document.webkitCurrentFullScreenElement === t
      ? t.style.width &&
        ((s = t.style.width), (l = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
  ...
  var h,
    ...
    P = {
      ...
      ConnectToProfiler: function () {
        if (m.ConnectToProfiler) return m.ConnectToProfiler.apply(m, arguments);
        m.print("Failed to execute ConnectToProfiler: Player not loaded yet.");
      },
      StopProfiling: function () {
        if (m.StopProfiling) return m.StopProfiling.apply(m, arguments);
        m.print("Failed to execute StopProfiling: Player not loaded yet.");
      },
      IsConnectedToProfiler: function () {
        if (m.IsConnectedToProfiler) return m.IsConnectedToProfiler.apply(m, arguments);
        m.print("Failed to execute IsConnectedToProfiler: Player not loaded yet.");
      },
      Quit: function () {
  ...
  function S(e, t, n) {
    -1 == e.indexOf("fullscreen error") &&
      (m.startupErrorHandler
        ...
        : (m.errorHandler && m.errorHandler(e, t, n)) ||
  ...
  function T(e, t) {
    if ("symbolsUrl" != e) {
      var n = m.downloadProgress[e],
        r =
          ((n =
            n || (m.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })),
          "object" != typeof t ||
  ...
  (m.SystemInfo = (function () {
      ...
      try {
        return window.WebAssembly
          ? WebAssembly.validate(
              new Uint8Array([
                0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 13, 1, 11, 0, 65, 0, 65,
                0, 65, 1, 252, 11, 0, 11,
              ]),
            )
            ? WebAssembly.validate(
                new Uint8Array([
                  0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 11, 1, 9, 1, 1, 125, 32, 0, 252, 0,
                  26, 11,
                ]),
              )
              ? WebAssembly.validate(
                  new Uint8Array([
                    0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 10, 1, 8, 1, 1, 126, 32, 0, 194, 26,
                    11,
                  ]),
                )
                ? WebAssembly.validate(
                  ...
                  ? !!WebAssembly.validate(
                      new Uint8Array([
                        0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 10, 1, 8, 0, 6, 64, 1, 25, 1,
                        11, 11,
                      ]),
                    ) || "wasm-exceptions"
                  : "wasm-simd128"
        ...
        (function o() {
          return void 0 === e
            ...
            : e.read().then(function (e) {
                ...
                return (
                  h + e.value.length <= l.length ? (l.set(e.value, h), (f = h + e.value.length)) : u.push(e.value),
                  (h += e.value.length),
                  i({
                    type: "progress",
                    response: a,
          ...
          return (
            i({ type: "load", response: a, total: e.length, loaded: e.length, lengthComputable: d, chunk: null }),
            (a.parsedBody = e),
            a
          );
        })
    ...
    (m.UnityCache =
      ...
      (E.prototype.connect = function () {
        var o = this;
        return void 0 === b
          ? Promise.reject(new Error("Could not connect to cache: IndexedDB is not supported."))
          : void 0 === window.caches
            ? Promise.reject(new Error("Could not connect to cache: Cache API is not supported."))
    ...
    (m.cachedFetch =
      ...
      function (o, a) {
                  ...
                  ? ((d.response = e),
                    ...
                    C(e, r.onProgress, r.enableStreamingDownload).then(function (e) {
                      return (
                        ...
                        Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(d.metaData)])
                          .then(function () {
        ...
        return (
          ...
          (d.revalidated = !1),
          (d.metaData = { url: s, accessedAt: Date.now(), version: d.productVersion }),
          (d.response = null),
          d.enabled
            ? i
                .loadRequest(s)
                  ...
                  return e
                    ? ((n = e.response),
                      ...
                      "immutable" == d.control
                        ...
                        : ((e = s),
                          ((t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0)) ||
                          (!n.headers.get("Last-Modified") && !n.headers.get("ETag"))
                            ? ((e = (a = a || {}).headers || {}),
                              ...
                              n.headers.get("Last-Modified")
                                ...
                                : n.headers.get("ETag") &&
                                  ((e["If-None-Match"] = n.headers.get("ETag")), (e["Cache-Control"] = "no-cache")),
                              c(o, a))
                                ...
                                return (
                                  ...
                                  d.revalidated
                                    ? (i.updateRequestMetaData(r).then(function () {
                                      ...
                                      C(d.response, a.onProgress, a.enableStreamingDownload))
                                    : c(o, a)
                                );
                              })))
                    : c(o, a);
                ...
                .catch(function (e) {
                  return (
                    U("Failed to load '" + d.metaData.url + "' from browser cache due to the error: " + e), v(o, a)
                  );
                })
            : v(o, a)
        );
    ...
    m.preRun.push(function () {
      m.addRunDependency("dataUrl"),
        a.then(function (t) {
          ...
          for (
            n + s > t.length &&
            o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")");
            n < s;
            ...
            m.postRun.push(function () {
              d(1),
                m.WebPlayer.WaitForInitialization().then(function () {
                  delete m.startupErrorHandler, e(P), (m.pageStartupTime = performance.now());
                });
            }),
